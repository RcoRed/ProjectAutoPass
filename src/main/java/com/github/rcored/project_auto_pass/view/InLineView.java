...
public class InLineView implements AbstractView{
    private static final char EXIT_KEY = 'q';
    private static Scanner console = new Scanner(System.in);
    private CrudService service;

    public InLineView(CrudService service) {
...
//                case 's', 'S' -> group = menuModificaGruppo(group);
//                case 'e', 'E' -> {
...
//    }
//
//    private static Group menuModificaGruppo(Group group) {
//        char choiceKey;
//        String groupNameId = null;
//        do {
//            System.out.println();
//            System.out.println("__________________ MODIFICA GRUPPO: " + group.getGroupNameId() + " __________________");
//            System.out.println("|-- * ----> Campo da modificare");
//            System.out.println("|-- a ----> Salva modifica");
//            System.out.println();
//            System.out.println("|-- q ----> Indietro | Annulla modifica");
//            System.out.println("_________________________________________________");
//            System.out.println("| ***  CAMPI M0DIFICABILI  *** |");
//            System.out.println("| -- 1 ----> NOME GRUPPO: " + group.getGroupNameId() +
//                    (group.getGroupNameId().equals(groupNameId) || groupNameId == null? "":" -- new --> " + groupNameId));
//            choiceKey = console.nextLine().charAt(0);
//            switch (choiceKey){
//                case 'a', 'A' -> {
//                    group = groupService.updateGroup(group,new Group(groupNameId,group.getAccounts()));
//                    System.out.println("| ***  GRUPPO MODIFICATO  *** |");
//                    choiceKey = 'q';    //per tornare alla visualizzazione del gruppo
//                }
//                case 'q', 'Q' -> {
//                    System.out.println("| ***  INDIETRO, MODIFICA ANNULLATA  *** |");
//                }
//                default -> {
//                    if (choiceKey-48 == 1){
//                        System.out.println("| ***  INSERISCI IL NUOVO NOME DEL GRUPPO  *** |");
//                        groupNameId = console.nextLine();
//                    }
//                }
//            }
//        } while (!(choiceKey == EXIT_KEY || choiceKey + 32 == EXIT_KEY)); //+32 per prendere e/E dato che un char sotto sotto è un numero
...
//        char choiceKey;
//        do {
//            account = accountService.readById(group, accountId).orElseThrow();
//            System.out.println();
...
//            switch (choiceKey) {
//                case 'q', 'Q' -> System.out.println("| ***  INDIETRO  *** |");
//                case 's', 'S' -> menuModificaAccount(group,);
//                case 'e', 'E' -> {
//                    System.out.println("| ***  SEI SICURO DI VOLER ELIMINARE QUESTO ACCOUNT?  *** |");
//                    System.out.println("| -- q ----> NO | ANNULLA |");
//                    System.out.println("| -- a ----> SI | ELIMINA |");
