...
/*
La classe PlatformTypeAdapter estende la classe TypeAdapter di Gson. Questa è una classe astratta che definisce due metodi, write e readById, che devono essere implementati. Questi metodi sono usati da Gson per serializzare e deserializzare oggetti.
...
Il metodo readById(JsonReader in) viene chiamato quando Gson deve deserializzare un oggetto Platform. Questo metodo legge l’oggetto Platform dal JsonReader fornito. Nel nostro caso, stiamo leggendo il tipo di Platform e le sue proprietà da una stringa JSON, e poi stiamo creando un nuovo oggetto Platform di quel tipo.
