...
public class CrudService implements AbstractGroupService, AbstractAccountService {
    ...
    /** Call the repo.readGroupByNameId() method to read a Group.
     * @param groupNameId It's the name of the Group that you want to read. The name can contain the .json type, if so it will be cut
    ...
    /** It will find all the Group in the GROUP_DIR_PATH, so all the Group created.
